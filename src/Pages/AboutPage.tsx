        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-20">
            ...
            >
              ...
              {/* Secondary Photo - Polaroid Style - Shows on desktop in right column */}
              <motion.div
                className="hidden lg:block bg-white p-4 sm:p-5 md:p-6 rounded-lg shadow-2xl"
          ...
          {/* MOBILE ONLY: Photo + Conclusion + Social Links */}
          <motion.div
          ...
          >
            {/* Secondary Photo - Polaroid Style - Mobile Only */}
          ...
          {/* DESKTOP ONLY: Conclusion + Social Links */}
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.6 }}
            className="hidden lg:block mt-12 md:mt-16 lg:mt-20 space-y-8"
          >
            {/* Conclusion */}
            <div>
              <p className="text-base sm:text-lg md:text-xl leading-relaxed text-neutral-300">
